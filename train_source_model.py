...
def get_args():
    ...
    parser.add_argument( "-s", "--input_size", type=int, default=32, help="The input size of dataset (default: 32)", )
...
def get_backbone(args, n_class=10):
    ...
    return model_dict[args.model](n_class, args.num_layers, input_size=args.input_size, conv_width=64).set_name(args.exp_name)
